      ...
      <div className="container-fluid hotel-secondary text-white pt-5">
        <div className="container">
          <footer className="py-2">
            <div className="row">
              <div className="col-sm-12 col-md-3 mb-3 p-0">
                <Logo />
              ...
              <div className="col-sm-12 col-md-3 mb-3 p-0 mt-3">
                <h5 className='fs-22 pb-5'>Our Blog</h5>
              ...
              <div className="col-sm-12 col-md-1 mb-3 p-0 mt-3">
                <h5 className='fs-22 pb-5 m-0'>Links</h5>
                <ul className="nav flex-column py-0">
              ...
              <div className="col-sm-12 col-md-4 offset-md-1 mb-3 p-0 mt-3">
                <h5 className='fs-22 pb-5 m-0'>Subscribe Newsletter</h5>
