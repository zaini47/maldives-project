  ...
  return (
    <div>
       <div className="container-fluid">
                <div className="row">
                    <div className="col-sm-12 col-md-6 bg-img2 py-5 px-4">
                    ...
                    <div className="col-sm-12 col-md-6 py-2">
                        <div className="text-start login-box">
                            <p className='fnt-set3 text-dark py-3'>Create your account</p>
                            <p className='fnt-set4'>It’s free and easy</p>
                            <form>
                            <InputFields
                                    name="Full name"
                                    type="text"
                                ...
                                <InputFields
                                    ...
                                    inputStyle='inputStyle'
                                />
                                <p className='text-start hotel-grey'>Must be 8 characters at least</p>
                                <div className='d-flex w-100 justify-content-between'>
                                <div >
                                    <input type="checkbox" />
                                </div>
                                <div className='w-95' >
                                    <p className='fnt-set8 fw-400'>By creating an account means you agree to the  <span className='text-dar fw-700'>Terms and Conditions</span>, and our <span className='text-dar fw-700'>Privacy Policy</span></p>
                                </div>
                            </div>
                            <div className='py-3'>
                                <Button
                            ...
                            <div className='text-center'>
                                <p className='fnt-set6 py-3'>Already have an account? <Link to="/login">Sign In</Link></p></div>
                        </div>
                    </div>
                </div>
            </div>
