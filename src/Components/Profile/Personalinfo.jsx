    ...
    <>
      ...
      <div className="container py-5">
        ...
        <div className="col-sm-12 col-md-12 col-lg-9">
          <p className='fs-52 ff-inter'>Personal info</p>
          <div className="row">
            <div className="col-md-6">
              <InputFeilds
                labelclass="fs-16 ff-inter fw-400 text-d"
                inputStyle='Style_input mb-5'
                name="FIRST NAME"
                type="text"
          ...
          <div className='row'>
            <p className='fs-21 ff-inter fw-500 text-d'>SOCIAL</p>
          </div>
          <div className="row">
            <div className="col-md-6">
              <InputFeilds
