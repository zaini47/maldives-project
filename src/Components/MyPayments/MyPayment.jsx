                ...
                <div className="container ">
                    <div className="row py-5">
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-3">
                            <div className="custom_profile">
                                <div className='aside_1'>
                                    ...
                                    <div>
                                        <Link to="/Profile/MyPayment" className='fs-18 ff-inter profile text-prim'>
                                            <svg className='mb-2 me-3' xmlns="http://www.w3.org/2000/svg" width="21" height="16" viewBox="0 0 21 16" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M17.7795 1.77778H3.55729C3.06637 1.77778 2.6684 2.17575 2.6684 2.66667V13.3333C2.6684 13.8243 3.06637 14.2222 3.55729 14.2222H17.7795C18.2704 14.2222 18.6684 13.8243 18.6684 13.3333V2.66667C18.6684 2.17575 18.2704 1.77778 17.7795 1.77778ZM3.55729 0C2.08453 0 0.890625 1.19391 0.890625 2.66667V13.3333C0.890625 14.8061 2.08453 16 3.55729 16H17.7795C19.2523 16 20.4462 14.8061 20.4462 13.3333V2.66667C20.4462 1.19391 19.2523 0 17.7795 0H3.55729Z" fill="#1CC3B2" />
                                                <path d="M7.11589 11.1112C7.11589 11.8475 6.51893 12.4445 5.78255 12.4445C5.04617 12.4445 4.44922 11.8475 4.44922 11.1112C4.44922 10.3748 5.04617 9.77783 5.78255 9.77783C6.51893 9.77783 7.11589 10.3748 7.11589 11.1112Z" fill="#1CC3B2" />
                                                <path d="M11.5573 11.1112C11.5573 11.8475 10.9603 12.4445 10.224 12.4445C9.48758 12.4445 8.89062 11.8475 8.89062 11.1112C8.89062 10.3748 9.48758 9.77783 10.224 9.77783C10.9603 9.77783 11.5573 10.3748 11.5573 11.1112Z" fill="#1CC3B2" />
                                                <path d="M0.890625 4.44434H20.4462V6.22211H0.890625V4.44434Z" fill="#1CC3B2" />
                                            </svg>
                                            My Payments</Link>
                                    </div>
                                    <div>
                        ...
                        <div className='col-sm-12 col-md-12 col-lg-9'>
                            ...
                            <div className='d-flex set-fc justify-content-between align-items-center'>
                                <div>
                                    <div>
                            ...
                            <div className='d-flex set-fc justify-content-between align-items-center py-2'>
                                <div>
                            ...
                            <div>
                                ...
                                <div className=' d-flex flex-column gap-42'>
                                    <div className=''>
                                        ...
                                        <div className='justify-content-center align-items-center row border-round margin-6'>
                                            <div className='border-r col-2 col-md-3 px-4'>
                                            ...
                                            <div className='col-1 display-sm-none'>
                                    ...
                                    <div className='set-fc d-flex justify-content-center gap-4  margin-6 mx-2'>
                                        <div className='col-sm-12 col-md-6 set-w'>
                                            <div>
                                    ...
                                    <div className='d-flex justify-content-between row' >
                                        <div className='set-fc d-flex  justify-content-between col-6 border-right pe-4'>
                                            <div>
                                        ...
                                        <div className='set-fc d-flex justify-content-between col-6 ps-4'>
                                            <div>
