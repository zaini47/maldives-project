        ...
        <>
            ...
            <div className="container py-5">
                <div className="row">
                    <div className="col-sm-12 col-md-3">
                        <div className='custom_profile'>
                            <div className='aside_1'>
                                <div>
                                    <Link to="/Personal info" className='fs-18 ff-inter profile Hotel-Grey'><svg className=' mb-2 me-3' xmlns="http://www.w3.org/2000/svg" width="17" height="20" viewBox="0 0 17 20" fill="none">
                    ...
                    <div className="col-sm-12 col-md-9 d-flex flex-column gap-4">
